...
public class Menu extends KarnaughGame implements KeyListener {
    ...
    public Menu() {
        ...
        rankB = new JButton("New Game"); //Ranked Game button.
        ...
        rankB.addActionListener(newGameActionListener());

        customB = new JButton("Open Map"); //Button that starts a custom game.
        customB.setVerticalTextPosition(AbstractButton.CENTER);
        customB.setHorizontalTextPosition(AbstractButton.CENTER);
        customB.addActionListener(loadMapActionListener());
    ...
    public JMenuBar createMenuBar() {
        ...
        file.setMnemonic('F');
        JMenuItem rankedItem = new JMenuItem("New Game");
        rankedItem.setMnemonic('R');
        file.add(rankedItem);
        JMenuItem customItem = new JMenuItem("Play Map");
        ...
        rankedItem.addActionListener(newGameActionListener());

        //Does everything the custom game button does.
        customItem.addActionListener(loadMapActionListener());
