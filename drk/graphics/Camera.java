...
public abstract class Camera implements GLRenderable,GLInitializable
{
	...
	public boolean isCollidedWith(Vector3D sphere,double radius)
	{
		Vector3D dist=sphere.minus(Position);
		return dist.mag2() < radius*radius;
	}
	public boolean isPointingAt(Vector3D sphere,double radius)
	{
		Vector3D v = sphere.minus(Position);
		double a = v.dot3(ZNormal);
